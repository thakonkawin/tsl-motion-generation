config = {
  ...
  "inference":{
    ...
    "detection":{
      "model_type": "yolo",
      "model_path": "./SMPLest-X/pretrained_models/yolov8x.pt",
      "conf": 0.5,
      "save": False,
      "verbose": False,
      "iou_thr": 0.5,
  ...
  "model": {
    ...
    "human_model_path": './SMPLest-X/human_models/human_model_files',
    'encoder_pretrained_model_path': './SMPLest-X/pretrained_models/vitpose_huge.pth',
    'encoder_config': {
        'num_classes': 80,
        'task_tokens_num': 80,
        'img_size': (256, 192),
