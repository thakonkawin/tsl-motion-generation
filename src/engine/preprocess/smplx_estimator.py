...
class SMPLXEstimator:
    ...
    #         self._logger.error(message=msg, module="SMPLXEstimator.smplx_estimator")
    ...
    #         self._logger.info(
    #             message=result.stdout, module="SMPLXEstimator.smplx_estimator"
    #         )
    ...
    #         msg = f"SMPLest-X inference failed: {e.stderr}"
    #         self._logger.error(message=msg, module="SMPLXEstimator.smplx_estimator")
