...
class CrossAttention(nn.Module):
    ...
    def forward(self, x, context=None, idx = 0):
        ...
        # if idx ==2:
        #     self.global_idx += 1
        #     overlay_attention_on_image( image_path="input.jpg",
        #         attn=attn,
        #         save_path=f"test_frames/attn_layer2/attn_overlay_{self.global_idx}.png"
        #         )
